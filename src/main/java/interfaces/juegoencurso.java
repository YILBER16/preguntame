...
public class juegoencurso extends javax.swing.JFrame {
    ...
    public juegoencurso(int idTorneo) {
       ...
       // Agregar un MouseListener para simular el comportamiento de un botón
        ...
        juegologica juego = new juegologica(labelpreguntas, labelopciona, labelopcionb, labelopcionc, labelopciond, btnsiguiente, idTorneo);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html>| -<sup>3</sup>&frasl;<sub>8</sub> | = | <sup>3</sup>&frasl;<sub>8</sub> |</html>");
        jLabel2.setToolTipText("");
        jPanel6.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 260, 430, 180));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/interfaces/gif3.gif"))); // NOI18N
        jLabel1.setText("jLabel1");
        jPanel6.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1540, 800));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new juegoencurso(idTorneo).setVisible(true);
            }
        });
    }
